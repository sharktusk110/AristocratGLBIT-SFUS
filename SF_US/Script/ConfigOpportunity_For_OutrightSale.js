function EditOpportunity_Page()
{
  ...
  Delay(2000);
    ...
    Aliases.browser.page__Account.Detail__tab.EditRemovalReason__Button.Click();
    //Aliases.browser.page__Opportunity.TypeEdit__button.Click();
    Delay(2000);
    
    Aliases.browser.page__Opportunity.TypeEdit__button.Regular__button.Keys("[Down][Down][Enter]");
    Delay(2000);
