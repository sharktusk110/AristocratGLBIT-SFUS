...
//Delays the test execution for the specified time period.
 ...
 // Delay(2000);
  ...
  Aliases.browser.Page__PreAccountApproval.Detail__Panel.Regular__Button.Type__Button.Click();
  //Delays the test execution for the specified time period.
    Delay(2000);
    Aliases.browser.Page__PreAccountApproval.Detail__Panel.Regular__Button.Click();
  Delay(2000);
  //Clicks the 'Regular_Tab' control.
  Aliases.browser.Page__PreAccountApproval.Detail__Panel.Regular__Button.Regular__Tab.Click();
  //Delays the test execution for the specified time period.
  Delay(2000);
